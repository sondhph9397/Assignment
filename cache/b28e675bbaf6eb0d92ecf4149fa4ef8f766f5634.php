                    ...
                    <div class="card card-primary">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <label for="" class="error"><?php echo e(isset($_GET['cate_nameerr']) ? $_GET['cate_nameerr'] : ""); ?></label>                            </div>
                              <div class="form-group">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Assignment\app\views/categories/add-form.blade.php ENDPATH**/ ?>